...
if __name__ == '__main__':
    TOKEN = 'MTQ3MjYwNzk0OTczNzE2OTA4Mw.G3XHxS.3Y_oZmJ8ir4Auvm29g6hhCZuSgJqWAmYC1FWc0'  # ← Cole o seu token aqui entre as aspas

    if not TOKEN or TOKEN == 'SEU_TOKEN_AQUI':
        print('=' * 60)
        print('  CONFIGURE O TOKEN DO BOT')
        print('  Abra o bot.py e substitua SEU_TOKEN_AQUI pelo token')
    ...
    try:
        ...
        logger.error('Token inválido! Verifique o TOKEN no código.')
